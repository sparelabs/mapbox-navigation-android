...
public class NavigationCamera implements LifecycleObserver {
  ...
  public void addProgressChangeListener(MapboxNavigation navigation) {
    this.navigation = navigation;
    // SBNOTE: I don't think the line below is still necessary because
    // startNavigation() in NavigationView will set a DynamicCamera
    // by default. I don't think this code would be reached with a null
    // camera reference.
