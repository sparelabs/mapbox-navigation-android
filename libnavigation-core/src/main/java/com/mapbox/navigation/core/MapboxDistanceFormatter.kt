...
class MapboxDistanceFormatter(private val context: Context, private val unitType: String, private val roundingIncrement: Int) : DistanceFormatter {
    ...
    override fun formatDistance(distance: Double): SpannableString {
        val distanceAndSuffix = when (distance) {
            ...
            in mediumDistanceLowerThreshold..mediumDistanceUpperThreshold -> {
                ...
                getDistanceAndSuffixForLargeUnit(distance, 0)
            }
        }
        return getSpannableDistanceString(distanceAndSuffix)
    }

    private fun getDistanceAndSuffixForSmallUnit(distance: Double): Pair<String, String> {
    ...
    private fun getDistanceAndSuffixForLargeUnit(distance: Double, maxFractionDigits: Int): Pair<String, String> {
     ...
     */
    fun getSpannableDistanceString(distanceAndSuffix: Pair<String, String>): SpannableString {
    ...
    private fun getUnitString(context: Context, unit: String) = when (unit) {
